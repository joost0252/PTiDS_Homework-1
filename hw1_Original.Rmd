...
#<source src="https://unils-my.sharepoint.com/personal/edward_tandia_unil_ch/_layouts/15/stream.aspx?id=%2Fpersonal%2Fedward%5Ftandia%5Funil%5Fch%2FDocuments%2FPièces%20jointes%2Ffinal%5Fvideo%2Emp4&ga=1" type="video/mp4">
</video> 
...
<b>We wish to use the function hide/unhide however it doesn't in an appropriate way
`r hide('Click here!') `
`r unhide() `

No matter we do, the bouton doesn't work properly. It doesn't display any answe.
</b>
</details>
